...
>
>   ```bash
>   sudo apt remove git zsh tmux netcat-traditional vim-gnome python python3 python3-pip neovim build-essential cmake python3-dev lua5.3 tightvncserver xfce4 xfce4-goodies powerline fonts-powerline ttf-wqy-zenhei autocutsel fcitx-googlepinyin
